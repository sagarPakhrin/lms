...
echo '		<form class="col s12" method="POST" action="./includes/updatebook.inc.php?id='.$id.'" enctype="multipart/form-data">';
echo '			<div class="row">';
...
echo '					<input id="id" name="id" type="text" class="validate" value="'.$row['id'].'" style="display:none">';
...
echo '<a href="bookdetail.php?id='.$row['id'].'" class="btn">Cancel</a>';
echo '		</div>';
echo '		</form>';
echo '	</div>';
echo '</div>';
